...
def main():    
    ...
    try:
        ...
        print 'Trouble plotting CA part: {0}'.format(e)
        print "Double chek the correct road-traffic-injuries-2002-2010.csv files are in 'data/'"

################################## NY  
    #severity2 = ['Injured', 'Killed']
    try:
        NY_data = InputData()
        NY_data.load_data('data/NYaccidents.csv',[ 'NUMBER OF PERSONS INJURED', 'NUMBER OF PERSONS KILLED', 
                        'DATE'])
        ...
        try:
            ...
            print 'Trouble plotting first part: {0}'.format(e)
        ...
        try:
            ...
            print 'Trouble plotting second part: {0}'.format(e)
    
    except Exception as e:
        print 'Trouble plotting NY part: {0}'.format(e)
        print "Check that the correct NYaccidents.csv files are in 'data/'"
